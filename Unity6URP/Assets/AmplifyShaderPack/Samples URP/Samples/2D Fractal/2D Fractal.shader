	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord12 = input.ase_texcoord2.xy * float2( 2,2 ) + float2( -1,-1 );
...
ASEEND*/
//CHKSM=DD6D5D5B2EB22E1D03E25442635A14E684927E24