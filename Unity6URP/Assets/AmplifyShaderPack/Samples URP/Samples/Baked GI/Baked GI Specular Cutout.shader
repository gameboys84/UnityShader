	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 temp_output_133_0_g14 = ( ( input.ase_texcoord7.xy * (_MainUVs).xy ) + (_MainUVs).zw );
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 temp_output_133_0_g14 = ( ( input.ase_texcoord1.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				float4 tex2DNode21_g14 = SAMPLE_TEXTURE2D( _MainTex, sampler_MainTex, temp_output_133_0_g14 );
				float MapBaseColorAlpha107_g14 = tex2DNode21_g14.a;
...
/*ASEBEGIN
Version=19904
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;33;-192,0;Inherit;False;Material Sample;1;;14;09f1910db887ebd4cb569d6c76c63be3;4,251,0,216,0,263,0,346,1;0;11;FLOAT3;1;FLOAT3;6;FLOAT3;328;FLOAT3;3;FLOAT3;5;FLOAT3;2;FLOAT3;4;FLOAT;8;FLOAT;71;FLOAT;72;FLOAT3;378
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;50;160,288;Inherit;False;Material Baked GI;35;;32;4963945102cd7c746bbe83f48754e7cb;8,910,1,827,1,826,1,838,1,831,1,839,1,1322,0,1323,0;3;975;FLOAT3;0,0,1;False;1246;FLOAT2;0,0;False;1250;FLOAT2;0,0;False;2;FLOAT3;948;FLOAT3;949
...
ASEEND*/
//CHKSM=0409523F292BAFBDB12576A2B319D1890F083B07