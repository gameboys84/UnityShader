	...
	UsePass "Hidden/Nature/Terrain/Utilities/SELECTION"
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				output.ase_texcoord6.xy = vertexToFrag286_g16;
				float2 vertexToFrag851_g16 = ( ( input.texcoord.xy * (_SnowMainUVs).xy ) + (_SnowMainUVs).zw );
				output.ase_texcoord7.xy = vertexToFrag851_g16;
						 ...
						 ) : SV_Target
			{
				...
				float2 vertexToFrag286_g16 = input.ase_texcoord6.xy;
				...
				float2 vertexToFrag851_g16 = input.ase_texcoord7.xy;
...
ASEEND*/
//CHKSM=E3F6E7EBE384CA5CEAA033BCA96253ABCA82642F