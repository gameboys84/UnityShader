	...
	UsePass "Hidden/Nature/Terrain/Utilities/SELECTION"
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				output.ase_texcoord7.xy = vertexToFrag286_g14;
						 ...
						 ) : SV_Target
			{
				...
				float2 vertexToFrag286_g14 = input.ase_texcoord7.xy;
	...
	UsePass "Hidden/Nature/Terrain/Utilities/SELECTION"
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				output.ase_texcoord1.xy = vertexToFrag286_g14;
						 ...
						 ) : SV_Target
			{
				...
				float2 vertexToFrag286_g14 = input.ase_texcoord1.xy;
				float4 tex2DNode283_g14 = SAMPLE_TEXTURE2D( _Control, sampler_Control, vertexToFrag286_g14 );
				float dotResult278_g14 = dot( tex2DNode283_g14 , half4( 1, 1, 1, 1 ) );
...
/*ASEBEGIN
Version=19904
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;53;333.8652,42.77539;Inherit;False;Terrain 4 Layer;0;;14;a8a57459582f78d4ca5db58f601fb616;4,504,1,102,1,669,0,668,0;0;8;FLOAT3;0;FLOAT3;14;FLOAT;56;FLOAT;45;FLOAT;200;FLOAT;282;FLOAT3;709;FLOAT4;701
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;64;336,288;Inherit;False;Constant;_AlphaClipThreshold1;AlphaClipThreshold;1;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=F31C3A41AEA012AF0D01C743499068D29C96F422