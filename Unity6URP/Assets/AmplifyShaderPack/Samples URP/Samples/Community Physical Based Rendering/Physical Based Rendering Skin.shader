	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				half3 reflectVector647_g1 = reflect( -ViewDirWS, Normal_WS1160_g1 );
				float3 indirectSpecular647_g1 = GlossyEnvironmentReflection( reflectVector647_g1, PositionWS, 1.0 - (_IndirectSpecularSmoothness*( 1.0 - Smoothness_417_g1 ) + Smoothness_417_g1), Occlusion435_g1, ScreenPosNorm.xy );
				...
				float3 View_Dir1334_g68764 = ViewDirWS;
				...
				float3 View_Dir1334_g68763 = ViewDirWS;
				...
				float3 WorldPosition98_g68747 = PositionWS;
				float2 ScreenUV98_g68747 = (ScreenPosNorm).xy;
				float3 WorldNormal98_g68747 = Normal_WS1160_g1;
				float3 ViewDir_WS1115_g1 = ViewDirWS;
				float3 ViewDirection98_g68747 = ViewDir_WS1115_g1;
				half4 localCalculateShadowMask2741_g1 = CalculateShadowMask2741_g1();
				float4 ShadowMask98_g68747 = localCalculateShadowMask2741_g1;
				float3x3 localAdditionalLightsData170x98_g68747 = AdditionalLightsData170x( WorldPosition98_g68747 , ScreenUV98_g68747 , WorldNormal98_g68747 , ViewDirection98_g68747 , ShadowMask98_g68747 );
				float3 break72_g68747 = localAdditionalLightsData170x98_g68747[ 0 ];
				...
				float3 View_Dir1334_g68761 = ViewDirWS;
				...
				float3 break74_g68747 = localAdditionalLightsData170x98_g68747[ 1 ];
				...
				float3 View_Dir1334_g68767 = ViewDirWS;
				...
				float3 bakedGI607_g1 = ASEBakedGI( PositionWS, Normal_WS1160_g1, ( uint2 )( ScreenPosNorm.xy * _ScreenSize.xy ), (input.ase_texcoord2.zw*(unity_LightmapST).xy + (unity_LightmapST).zw), (input.ase_texcoord5.xy*(unity_DynamicLightmapST).xy + (unity_DynamicLightmapST).zw), true);
				...
				float3 Scene_Lighting1527_g1 = max( localAdditionalLightsData170x98_g68747[ 2 ] , temp_output_1609_0_g1 );
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				float2 vertexToFrag795_g1 = ( ( input.ase_texcoord.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				output.ase_texcoord1.xy = vertexToFrag795_g1;
						 ...
						 )
			{
				...
				float2 vertexToFrag795_g1 = input.ase_texcoord1.xy;
				float4 tex2DNode35_g1 = tex2D( _MainTex, vertexToFrag795_g1 );
				float Alpha79_g1 = tex2DNode35_g1.a;
